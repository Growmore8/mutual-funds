...
<div x-data="{
        ...
        scopeLabel(){ return {fund:'Mutual Fund', spot:'Spot Trading', all:'All accounts'}[this.scope]; },
            ...
            <div class="relative bg-white dark:bg-[#0f1b38] dark:ring-1 dark:ring-white/10 rounded-2xl shadow-xl w-full max-w-sm p-5 text-sm">
                ...
                <div x-show="step===1">
                    ...
                    <div class="space-y-2">
                        ...
                        <button @click="pick('spot')" class="w-full text-left px-3 py-2.5 rounded-lg border border-gray-200 dark:border-white/10 hover:border-blue-400"><i class="fa-solid fa-arrow-trend-up text-blue-500 mr-1"></i> Spot Trading</button>
