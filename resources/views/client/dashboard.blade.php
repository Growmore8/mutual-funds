    ...
    <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-6">
        <div>
            ...
            @if ($user->fundAccounts->count() > 1)
                <a href="{{ route('profile.edit') }}" class="lg:hidden inline-flex items-center gap-1.5 mt-2 text-xs px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-800 dark:bg-emerald-500/15 dark:text-emerald-300">
