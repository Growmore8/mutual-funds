...
@if($hero)
<div class="lg:hidden fixed inset-0" style="z-index:0;background-image:linear-gradient(to bottom,rgba(7,11,22,.80) 0%,rgba(7,11,22,.55) 30%,rgba(7,11,22,.88) 64%,rgba(7,11,22,1) 100%),url('{{ $hero }}?v={{ $brandV }}');background-size:cover;background-position:center 30%;background-repeat:no-repeat"></div>
@endif
