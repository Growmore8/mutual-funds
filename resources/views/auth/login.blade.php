...
@if($hero)
<div class="lg:hidden fixed inset-0" style="z-index:0;background-color:#070b16;background-image:linear-gradient(to bottom,rgba(7,11,22,0) 0%,rgba(7,11,22,.05) 38%,rgba(7,11,22,.80) 72%,#070b16 100%),url('{{ $hero }}?v={{ $brandV }}');background-size:100% 100%,contain;background-position:center,center top;background-repeat:no-repeat,no-repeat"></div>
@endif
