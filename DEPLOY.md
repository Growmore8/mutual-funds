# Deploy — GrowthCapital Mutual Funds (funds.growthcapitalltd.com)
...
- Application: **Generic**  ·  Domain: **funds.growthcapitalltd.com**  ·  PHP: **8.3**
...
```bash
cd /home/funds/htdocs/funds.growthcapitalltd.com
rm -rf ./* ./.[!.]* 2>/dev/null
...
APP_ENV=production
APP_DEBUG=false
APP_URL=https://funds.growthcapitalltd.com
...
chown -R funds:funds /home/funds/htdocs/funds.growthcapitalltd.com
...
```
root /home/funds/htdocs/funds.growthcapitalltd.com/public;
```
